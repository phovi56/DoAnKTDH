 ...
 * @author Apple Bee
 */
public class Lineof3D {

    private int x1, x2, y1, y2;

    public Lineof3D(int x1, int y1, int x2, int y2) {
        this.x1 = x1 * 5;
        this.y1 = y1 * 5;
        this.x2 = x2 * 5;
        this.y2 = y2 * 5;
    ...
    public void draw(Graphics2D g) {
        ...
        g.fillRect(x + InputData.Width / 2 - 2, InputData.Height / 2 - y - 2, 5, 5);
    ...
    public void draw1 (Graphics2D g) {
        ...
        g.fillRect(x + 700 / 2 - 2, InputData.Height / 2 - y - 2, 5, 5);
